      ...
      <section class="auth-content">
        <router-link to="/home" class="auth-brand" :aria-label="siteName">
          ...
          <span class="auth-brand-copy">
            ...
            <span v-if="siteSubtitle" class="auth-brand-subtitle">{{ siteSubtitle }}</span>
          </span>
        </router-link>
...
import { DEFAULT_BRAND_NAME, DEFAULT_FAVICON } from '@/utils/branding'

const { t } = useI18n()
const appStore = useAppStore()

const siteName = computed(() => appStore.siteName || DEFAULT_BRAND_NAME)
