...
import type { BasePaginationResponse, ReceiptCodePaymentMethod, WithdrawalRequest } from '@/types'
...
export const adminPaymentAPI = {
  ...
  /** Record an externally verified payment, then run normal fulfillment. */
