...
import adminCarpoolsAPI from './carpools'
import modulesAPI from './modules'
import adminRevenueAPI from './revenue'
...
export const adminAPI = {
  ...
  carpools: adminCarpoolsAPI,
  modules: modulesAPI,
  revenue: adminRevenueAPI,
  store: adminStoreAPI,
  accountShare: accountShareAPI
}
...
export type { AdminCarpoolPoolSummary } from './carpools'
