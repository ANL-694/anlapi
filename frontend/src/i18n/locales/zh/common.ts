export default {
  withdrawal: {
    title: '余额提现与收款码', description: '共享收入余额可提现，最低 1.00 元，金额最多保留两位小数。首次提交提现申请额外扣除 0.10 元。',
    availableBalance: '可提现余额', status: '提现状态', pending: '已有待结算', canSubmit: '可提交',
    submitTitle: '提交提现', pendingHint: '同一用户只能保留一笔待结算提现。', amount: '提现金额', receiptCode: '本次收款码',
    firstFee: '首次手续费', totalDeducted: '本次扣除', submit: '提交提现申请',
    receiptManagement: '收款码管理', receiptHint: '上传后保存，提交提现时会保存本次收款码快照。', notUploaded: '未上传{method}收款码',
    savedAt: '已保存于 {date}', notSaved: '当前方式还未保存收款码', draftHint: '已选择新图片，保存后才能用于提现。', upload: '上传', clear: '清除',
    receiptDelete: '删除', history: '提现记录', historyHint: '待结算申请可取消，取消后金额退回余额。', recent: '最近 {count} 笔', cancel: '取消提现', empty: '暂无提现记录',
    submitPending: '已有待结算提现，处理完成或取消后才能再次提交。', saveDraftFirst: '新收款码需要先保存，保存后本次提现才会使用它。', uploadFirst: '请先上传并保存本次要使用的收款码。',
    invalidAmount: '提现金额最低 1.00 元，且最多两位小数。', insufficient: '余额不足以覆盖提现金额和手续费。', confirmInput: '请确认金额、余额和收款码后再提交。',
    invalidType: '收款码必须是 PNG、JPEG、GIF 或 WebP 图片', tooLarge: '收款码图片不能超过 1MB', selectFile: '请先选择收款码图片',
    saved: '收款码已保存', saveFailed: '收款码保存失败', deleted: '收款码已删除', deleteFailed: '收款码删除失败', submitted: '提现申请已提交', submitFailed: '提现申请提交失败', cancelled: '提现申请已取消', cancelFailed: '取消提现失败', loadFailed: '提现信息加载失败',
    methods: { alipay: '支付宝', wechat: '微信' }, statuses: { pending: '待结算', settled: '已结算', cancelled: '已取消', rejected: '已拒绝' }
  },
  common: {
    loading: '加载中...',
    submitting: '提交中...',
