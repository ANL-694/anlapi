export default {
  dashboard: {
    ...
    platformUsageTitle: '平台用量',
    platformUsageHint: '按上游平台查看今日与累计用量',
    platformCount: '{count} 个平台',
    platformOther: '其他',
    platformQuota: {
      title: '配额用量',
      hint: '按平台与时间窗口显示已配置的余额限额',
      empty: '未配置平台限额',
      notStarted: '尚未开始',
      daily: '日',
      weekly: '周',
    ...
    accountSharing: {
      title: '账号共享',
      hint: '总计包含私有账号；详情仅展示公开共享账号。',
      settlement: '基于已应用的结算记录',
      ownedAccounts: '自有账号',
      publicAccounts: '公开账号',
      privateMode: '私有账号',
      publicPending: '待审核公开',
      publicApproved: '已通过公开',
      publicSuspended: '已暂停公开',
      selfAccountCost: '自用账号成本',
      selfUsage: '自用用量',
      selfActualCost: '自用实际扣款',
      externalRequests: '外部请求',
      externalConsumerCharge: '外部消费者扣款',
      externalUsage: '外部用量',
      ownerCredit: '所有者入账',
      platformFee: '平台服务费',
      balanceNetChange: '余额净变化',
      totalAccountCost: '账号总成本',
      ownedAccountBreakdown: '自有账号明细',
      shareStatus: '共享状态',
      netChange: '净变化',
      account: '共享账号',
      trend: '共享趋势',
  ...
  keys: {
    ...
    testModelModal: {
      ...
      incompleteResponse: '模型响应在流结束标记前中断。',
      invalidResponse: '模型响应包含无效的流事件。',
      testFailed: '模型测试失败',
      completed: '模型响应正常',
      start: '开始测试',
      retry: '重新测试',
  ...
  affiliate: {
    ...
    period: {
      title: '返利时间范围',
      description: '查看指定时间范围内的邀请消费与返利。',
      today: '今天',
      last7: '近 7 天',
      start: '开始',
      end: '结束',
      invalid: '开始时间必须早于结束时间。'
    },
    tips: {
      title: '使用说明',
