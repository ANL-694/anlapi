export default {
    ...
    subscriptions: {
      ...
      bulk: {
        assignMultiple: '批量选择用户',
        confirm: '确认批量{action}',
        confirmTargets: '已选择 {count} 个订阅',
        extendHint: '为所选订阅增加下方填写的天数。',
        groupFallback: '分组 #{id}',
        invalidDays: '请输入有效的天数。',
        itemFailed: '此订阅操作失败。',
        requestFailed: '批量操作失败，请重试。',
        resetHint: '重置所选订阅的用量窗口。',
        resetWindows: '重置日、周、月窗口',
        result: '成功：{success}；失败：{failed}',
        retry: '重试失败项',
        retryHint: '只会重试失败的项目。',
        selectWindow: '至少选择一个用量窗口。',
        selectionLimit: '最多选择 100 个订阅。',
        selectionRequired: '至少选择一个订阅。',
        extend: '延长订阅',
        extendHintTitle: '延长所选订阅',
        reset: '重置配额',
        resetHintTitle: '重置所选配额'
      },
      guide: {
        title: '订阅管理教程',
