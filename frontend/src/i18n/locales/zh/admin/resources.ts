export default {
    ...
    emailBroadcast: {
      title: '批量公告邮件',
      description: '通过邮箱将公告内容批量发送给指定用户或所有已注册用户。',
      ...
      preview: {
        ...
        refreshing: '更新中...',
        error: '预览生成失败',
        hint: '预览结果与最终投递的邮件一致，已应用统一排版与站点名头部。',
        iframeTitle: '公告邮件预览',
        placeholderSubject: '（在左侧填写邮件主题）',
        placeholderBody: '（在左侧填写邮件正文，HTML 或纯文本格式均支持。预览会实时更新。）'
      },
      toolbar: {
        p: '段落（包裹选中文本为 <p>）',
        b: '加粗（包裹为 <strong>）',
    ...
    modules: {
      title: '运行模块',
      description: '查看已注册运行模块及其当前状态',
      noModules: '暂无已注册的运行模块',
      noModulesDescription: '服务启动模块后会在这里显示。',
      failedToLoad: '加载运行模块失败',
      columns: {
        id: '模块 ID',
        namespace: '命名空间',
        name: '名称',
