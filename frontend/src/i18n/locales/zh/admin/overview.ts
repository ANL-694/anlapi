export default {
    ...
    groups: {
      ...
      compositeRoutes: {
        ...
        manage: '管理聚合路由',
        title: '聚合分组路由',
        description: '将公开模型名解析到目标平台和上游模型。未命中显式规则时，系统会尝试按模型名识别平台。',
        addRoute: '新增路由',
        editRoute: '编辑路由',
        reset: '重置表单',
        publicModel: '公开模型名',
        publicModelPlaceholder: '例如：team-gpt',
        upstreamModel: '上游模型名',
        upstreamModelPlaceholder: '留空则沿用公开模型名',
        matchType: '匹配方式',
        targetPlatform: '目标平台',
        endpoint: '接口',
        priority: '优先级',
        enabled: '启用',
        notes: '备注',
        notesPlaceholder: '可选，供管理员识别用途',
        loading: '正在加载路由...',
        noRoutes: '暂无显式路由规则',
        listTitle: '路由规则（{count}）',
        deleteRoute: '删除路由',
        deleteConfirm: '确定删除公开模型「{model}」的路由吗？',
        created: '聚合路由已创建',
        updated: '聚合路由已更新',
        deleted: '聚合路由已删除',
        loadFailed: '加载聚合路由失败',
        saveFailed: '保存聚合路由失败',
        deleteFailed: '删除聚合路由失败',
        previewTitle: '解析预览',
        previewHint: '使用当前已保存的规则模拟一次模型解析，不会发送上游请求。',
        previewModel: '请求模型名',
        previewModelPlaceholder: '输入待解析的模型名',
        preview: '预览解析',
        previewMatched: '已匹配路由',
        previewNoMatch: '未匹配路由',
        previewSource: '来源',
        previewTarget: '目标平台',
        previewUpstream: '上游模型',
        previewFailed: '预览聚合路由失败',
        matchTypes: {
          exact: '精确匹配',
          prefix: '前缀匹配'
        },
      ...
      openaiLive: {
        title: 'OpenAI Live',
        allow: '允许访问 Live',
        hint: '启用后，此 OpenAI 分组的 API Key 可以创建并控制 Live 语音会话。默认关闭。运行 ANLAPI 的服务端必须是 Apple Silicon Mac，并安装官方 ChatGPT App；客户端平台不受限制。',
        unsupportedTitle: '当前服务端不支持 Live',
        unsupportedMessage: '当前 ANLAPI 服务端无法生成 Live 所需的设备证明，即使开启也不能使用。是否仍然开启？',
        enableAnyway: '仍然开启'
      },
