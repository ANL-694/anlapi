    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          hideUserRanking: '对用户隐藏渠道监控排行',
          hideUserRankingHint: '开启后，用户端渠道监控页面不显示排行和榜单详情。',
        },
        availableChannels: {
          title: '可用渠道',
        ...
        siteBillingMode: {
          title: '站点计费模式',
          description: '选择用户端可用的余额充值和订阅功能组合。',
          label: '计费模式',
          options: {
          ...
          hints: {
            rechargeAndSubscription: '用户可以余额充值并购买订阅。',
            rechargeOnly: '用户可以余额充值；订阅购买和分配入口隐藏。',
            subscriptionOnly: '用户可以购买订阅；余额充值关闭。'
          }
        },
        riskControl: {
          title: '风控中心',
      ...
      customMenu: {
        ...
        openInNewWindowHint: '启用后，点击该菜单项会在新窗口打开页面。',
