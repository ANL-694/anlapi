export default {
    settings: {
      ...
      dingtalk: {
        title: '钉钉登录',
        description: '配置钉钉 OAuth，用于 ANLAPI 用户登录',
      ...
      upstreamBillingProbe: {
        title: '上游倍率自动探测',
        description: '定期获取 OpenAI API Key 所连接上游 ANLAPI 站点声明的计费倍率。',
        enabled: '启用全局自动探测',
      ...
      payment: {
        ...
        easypayCustomMethodsHint: '添加当前易支付服务商额外支持的支付方式。支付方式会记录到 ANLAPI 订单中，上游 type 会作为易支付 type 参数提交。',
