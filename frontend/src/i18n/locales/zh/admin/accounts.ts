export default {
    accounts: {
      ...
      opencodeGo: {
        protocolRules: {
          title: '协议路由规则',
          hint: '匹配模型模式并选择 OpenCode Go 使用的上游协议。',
      ...
      grokMediaEligibility: {
        title: 'Grok 媒体生成资格',
        hint: '选择自动判断，或为此 OAuth 账号强制启用/禁用媒体生成。',
        auto: '自动判断',
        enabled: '强制启用',
        disabled: '强制禁用',
        loading: '正在加载当前资格…',
        ...
        eligible: '可用',
        ineligible: '不可用',
        loadFailed: '无法加载媒体生成资格',
        partialSave: '账号已保存，但媒体生成资格更新失败。',
        forceEnableWarning: '如果上游账号实际不具备资格，强制启用可能导致请求失败。',
        autoHint: '自动模式根据最新账单和账号信号判断。',
        reasons: {
          billing_inconclusive: '账单信息不足',
          override_enabled: '手动启用',
          override_disabled: '手动禁用'
        }
      },
