...
const anlEnOverrides = {
  ...
  httpStatusCodes: {
    ...
    description: 'Browse common HTTP status codes and their brief meanings by category.',
    codes: 'codes',
    note: 'The exact meaning of a status code can also depend on the HTTP method, response headers, and application protocol.',
  },
  ...
  keys: {
    ...
    deleteSystemConfirmMessage: "Regenerate '{name}'? The current key will be revoked and the system will immediately create a new image-generation key.",
    systemManaged: 'Auto-assigned',
    imageGenerationRoute: 'GPT image route',
    apiKey: 'API Key',
    group: 'Group',
    ...
    keyCreatedRevealTitle: 'Save your API key now',
    keyCreatedRevealWarning: 'The full key is shown only in this session. It cannot be recovered after leaving or refreshing the page, so copy and store it securely now.',
    keyCreatedRevealHint: 'Lists and later read requests show only a masked value. Only a key created in this session can be used, tested, or imported here.',
    keyValueUnavailable: 'The full API key is unavailable. Create or regenerate the key before using this action.',
    ...
    systemGroupLocked: 'The GPT image key is automatically assigned to the administrator-selected image generation group and is ready to use',
    ...
    testModelModal: {
      title: 'Test API key',
      description: 'Read the models available to this key, then send a minimal chat request to verify model access.',
      modelLabel: 'Select model',
      modelPlaceholder: 'Select a model to test',
      loadingModels: 'Loading available models...',
      modelsLoaded: 'Loaded {count} testable models',
      noModels: 'This API key has no models available for chat testing.',
      missingKey: 'The API key value is unavailable, so it cannot be tested.',
      loadFailed: 'Failed to load available models',
      ready: 'Ready to test',
      testing: 'Testing...',
      starting: 'Sending a test request with {model}',
      promptHint: 'Test prompt: Reply with exactly OK.',
      usageHint: 'The test makes one minimal model request and counts toward this API key usage.',
      requestFailed: 'Request failed',
      noResponseBody: 'The server returned no response body',
      emptyResponse: 'The model returned an empty response, but the request succeeded.',
      testFailed: 'Model test failed',
      completed: 'Model responded successfully',
      start: 'Start test',
      retry: 'Retry test',
      status: {
        idle: 'Waiting',
  ...
  usage: {
    ...
    cacheCreation5mHint: '5-minute cache creation tokens',
    cacheCreation1hHint: '1-hour cache creation tokens',
    totalRequests: 'Total Requests',
    totalTokens: 'Total Tokens',
    totalCost: 'Total Cost',
  ...
  profile: {
    ...
    share: {
      ...
      image: 'Share Image',
      websiteText: "View {name}'s anl profile",
  ...
  admin: {
    ...
    accounts: {
      ...
      openai: {
        ...
        imageApiKeyTitle: 'GPT Image Key / Upstream',
        imageApiKeyDesc: 'OpenAI API key or compatible image upstream',
        imageApiKeyBaseUrlHint: 'The official OpenAI URL is prefilled. Change it only for an OpenAI-compatible image upstream.',
        imageApiKeyGroupRequirement: 'This account must be bound to an OpenAI image group with allow_image_generation=true. Quick mode only lists eligible groups.',
        imageApiKeyNoEligibleGroup: 'No eligible OpenAI image group is available. Enable image generation in group management first.',
        imageApiKeyGroupRequired: 'Select an OpenAI group with image generation enabled first.',
        imageApiKeyModelRestriction: 'GPT Image model whitelist',
        imageApiKeyModelsLocked: 'Quick mode is locked to the GPT Image models currently supported by this project and cannot submit other models.',
    ...
    settings: {
      ...
      autoModel: {
        ...
        virtualNamePlaceholder: 'e.g. anl-auto',
        ruleEnabled: 'Enabled',
...
const parityEnSupplement = {
  ...
  admin: {
    accounts: {
      ...
      noAccountsDescription: 'Add an account to start routing requests.',
...
export default mergeLocaleMessages(mergeLocaleMessages(sub2En, anlEnOverrides), parityEnSupplement)
