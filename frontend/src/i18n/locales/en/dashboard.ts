export default {
  dashboard: {
    ...
    platformUsageHint: 'Today and lifetime usage by upstream platform',
    platformCount: '{count} platforms',
    platformOther: 'Other',
    platformQuota: {
      title: 'Quota Usage',
      hint: 'Configured balance quotas by platform and window',
      empty: 'No platform quota is configured',
    ...
    accountSharing: {
      ...
      hint: 'Private accounts are included in totals; details show public shared accounts only.',
      settlement: 'Based on applied settlement records',
      ownedAccounts: 'Owned accounts',
      publicAccounts: 'Public accounts',
      privateMode: 'Private accounts',
      publicPending: 'Public pending',
      publicApproved: 'Public approved',
      publicSuspended: 'Public suspended',
      selfAccountCost: 'Self-use account cost',
      selfUsage: 'Self-use usage',
      selfActualCost: 'Self-use actual debit',
      externalRequests: 'External requests',
      externalConsumerCharge: 'External consumer charge',
      externalUsage: 'External usage',
      ownerCredit: 'Owner credit',
      platformFee: 'Platform fee',
      balanceNetChange: 'Balance net change',
      totalAccountCost: 'Total account cost',
      ownedAccountBreakdown: 'Owned account details',
      shareStatus: 'Share status',
      netChange: 'Net change',
      account: 'Shared account',
      trend: 'Sharing trend',
      period: 'Period',
      empty: 'No public shared-account details to display',
    },
  ...
  keys: {
    ...
    testModelModal: {
      ...
      incompleteResponse: 'The model response ended before the stream completed.',
      invalidResponse: 'The model response contained an invalid stream event.',
  ...
  affiliate: {
    ...
    period: {
      title: 'Rebate period',
      description: 'Review invite consumption and rebate for a selected period.',
      today: 'Today',
      last7: 'Last 7 days',
      start: 'Start',
      end: 'End',
      invalid: 'The period must have a valid start before its end.'
    },
    tips: {
      title: 'How It Works',
