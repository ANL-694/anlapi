export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      grok: {
        description: 'Configure Grok Build, Claude Code, Codex, or OpenCode to send requests through your ANLAPI Grok group.',
        claudeDescription: 'Configure Claude Code to send Messages API traffic through your ANLAPI Grok group.',
        codexDescription: 'Configure Codex to send Responses API traffic through your ANLAPI Grok group.',
        ...
        codexNote: 'Save config.toml under ~/.codex and set ANLAPI_API_KEY before starting Codex.',
        codexNoteWindows: 'Save config.toml under %USERPROFILE%\\.codex and set ANLAPI_API_KEY in PowerShell before starting Codex.',
      },
      opencode: {
