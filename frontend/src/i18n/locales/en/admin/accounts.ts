    ...
    accounts: {
      ...
      opencodeGo: {
        protocolRules: {
          ...
          hint: 'Match a model pattern and choose the upstream protocol used by OpenCode Go.',
          patternPlaceholder: 'e.g. gpt-5*',
          fallback: 'Use the account default protocol',
          add: 'Add protocol rule',
          remove: 'Remove protocol rule',
      ...
      grokMediaEligibility: {
        title: 'Grok media generation eligibility',
        hint: 'Choose whether media generation is detected automatically or overridden for this OAuth account.',
        auto: 'Automatic',
        enabled: 'Force enabled',
        disabled: 'Force disabled',
        loading: 'Loading current eligibility…',
        current: 'Current decision:',
        eligible: 'eligible',
        ineligible: 'ineligible',
        loadFailed: 'Unable to load media eligibility',
        partialSave: 'Account saved, but media eligibility could not be updated.',
        forceEnableWarning: 'Force enabling media generation may fail upstream if this account is not eligible.',
        autoHint: 'Automatic mode uses the latest billing and account signals.',
        reasons: {
          billing_inconclusive: 'billing inconclusive',
          override_enabled: 'manually enabled',
          override_disabled: 'manually disabled'
        }
      },
