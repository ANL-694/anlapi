export default {
    ...
    emailBroadcast: {
      ...
      preview: {
        ...
        hint: 'Preview matches the final delivered email, including the shared layout and site-name header.',
    ...
    modules: {
      ...
      description: 'Inspect registered runtime modules and their current state',
      noModules: 'No runtime modules are registered',
      noModulesDescription: 'Registered modules will appear here when the service starts them.',
      failedToLoad: 'Failed to load runtime modules',
      columns: {
        id: 'Module ID',
        namespace: 'Namespace',
        name: 'Name',
