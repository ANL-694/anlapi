export default {
    settings: {
      ...
      dingtalk: {
        ...
        description: 'Configure DingTalk OAuth for ANLAPI end-user login',
      ...
      upstreamBillingProbe: {
        ...
        description: 'Periodically retrieve billing rates declared by upstream ANLAPI sites connected to OpenAI API keys.',
      ...
      payment: {
        ...
        alipayMobilePrecreateDeepLinkHint:
          'Off by default. Only affects mobile balance and subscription orders using official Alipay via hosted_redirect: precreate opens Alipay and falls back to a dynamic QR code. EasyPay, Shop orders, and desktop are unaffected',
        helpText: 'Help Text',
        ...
        easypayCustomMethodsHint: 'Add provider-specific methods supported by this EasyPay endpoint. The payment type is stored on ANLAPI orders; the upstream type is sent as EasyPay type.',
