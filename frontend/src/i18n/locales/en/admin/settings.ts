    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          hideUserRanking: 'Hide user ranking from channel monitor',
          hideUserRankingHint: 'When enabled, user-facing channel monitor pages omit ranking and leaderboard details.',
        },
        availableChannels: {
        ...
        siteBillingMode: {
          ...
          description: 'Choose which balance recharge and subscription surfaces are available to users.',
          label: 'Billing mode',
          options: {
            rechargeAndSubscription: 'Recharge + subscriptions',
            rechargeOnly: 'Recharge only',
            subscriptionOnly: 'Subscriptions only'
          },
          hints: {
            rechargeAndSubscription: 'Users can add balance and purchase subscriptions.',
            rechargeOnly: 'Users can add balance; subscription purchase and assignment surfaces are hidden.',
            subscriptionOnly: 'Users can purchase subscriptions; balance recharge is disabled.'
          }
        },
        riskControl: {
          title: 'Risk Control',
      ...
      customMenu: {
        ...
        openInNewWindowHint: 'When enabled, clicking this menu item opens the page in a new window.',
