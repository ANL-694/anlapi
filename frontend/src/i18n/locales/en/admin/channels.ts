export default {
    ...
    subscriptions: {
      ...
      bulk: {
        assignMultiple: 'Assign multiple users',
        confirm: 'Confirm bulk {action}',
        confirmTargets: '{count} subscriptions selected',
        extendHint: 'Extend the selected subscriptions by the number of days below.',
        groupFallback: 'Group #{id}',
        invalidDays: 'Enter a valid number of days.',
        itemFailed: 'This subscription failed.',
        requestFailed: 'Bulk operation failed. Please retry.',
        resetHint: 'Reset the selected subscription usage windows.',
        resetWindows: 'Reset daily, weekly, and monthly windows',
        result: 'Succeeded: {success}; failed: {failed}',
        retry: 'Retry failed items',
        retryHint: 'Only failed items will be retried.',
        selectWindow: 'Select at least one usage window.',
        selectionLimit: 'Select no more than 100 subscriptions.',
        selectionRequired: 'Select at least one subscription.',
        extend: 'Extend subscriptions',
        extendHintTitle: 'Extend selected subscriptions',
        reset: 'Reset quota',
        resetHintTitle: 'Reset selected quotas'
      },
      guide: {
