export default {
    ...
    groups: {
      ...
      compositeRoutes: {
        action: 'Routes',
        manage: 'Manage composite routes',
        title: 'Composite Group Routes',
        description: 'Resolve public model names to a target platform and upstream model. When no explicit rule matches, the platform is inferred from the model name.',
        addRoute: 'Add Route',
        editRoute: 'Edit Route',
        reset: 'Reset Form',
        publicModel: 'Public Model',
        publicModelPlaceholder: 'For example: team-gpt',
        upstreamModel: 'Upstream Model',
        upstreamModelPlaceholder: 'Leave empty to keep the public model name',
        ...
        enabled: 'Enabled',
        notes: 'Notes',
        notesPlaceholder: 'Optional admin-facing note',
        loading: 'Loading routes...',
        noRoutes: 'No explicit route rules yet',
        listTitle: 'Route Rules ({count})',
        deleteRoute: 'Delete Route',
        deleteConfirm: 'Delete the route for public model "{model}"?',
        created: 'Composite route created',
        updated: 'Composite route updated',
        deleted: 'Composite route deleted',
        loadFailed: 'Failed to load composite routes',
        saveFailed: 'Failed to save composite route',
        deleteFailed: 'Failed to delete composite route',
        previewTitle: 'Resolution Preview',
        previewHint: 'Simulates model resolution against saved rules and does not call an upstream provider.',
        previewModel: 'Requested Model',
        previewModelPlaceholder: 'Enter a model name to resolve',
        preview: 'Preview Resolution',
        previewMatched: 'Route matched',
        previewNoMatch: 'No route matched',
        previewSource: 'Source',
        previewTarget: 'Target platform',
        previewUpstream: 'Upstream model',
        previewFailed: 'Failed to preview composite route',
        matchTypes: {
          exact: 'Exact',
          prefix: 'Prefix'
        },
      ...
      openaiLive: {
        ...
        hint: 'When enabled, API keys in this OpenAI group can create and control Live voice sessions. Disabled by default. The ANLAPI server must run on Apple Silicon macOS with the official ChatGPT app installed; client platforms are unrestricted.',
        unsupportedTitle: 'Current server does not support Live',
        unsupportedMessage: 'This ANLAPI server cannot generate the required Live attestation. Live will not work even if enabled. Continue anyway?',
