export default {
  withdrawal: {
    title: 'Balance withdrawal and receipt codes', description: 'Shared-income balance can be withdrawn. Minimum 1.00, up to two decimals. The first request has an additional 0.10 fee.',
    availableBalance: 'Available to withdraw', status: 'Withdrawal status', pending: 'Pending settlement', canSubmit: 'Ready to submit',
    submitTitle: 'Submit withdrawal', pendingHint: 'Each user can have only one pending withdrawal.', amount: 'Withdrawal amount', receiptCode: 'Receipt code for this withdrawal',
    firstFee: 'First-request fee', totalDeducted: 'Total deducted', submit: 'Submit withdrawal',
    receiptManagement: 'Receipt code management', receiptHint: 'Save the upload before submitting; the submitted request stores a snapshot.', notUploaded: 'No {method} receipt code uploaded',
    savedAt: 'Saved on {date}', notSaved: 'No receipt code saved for this method', draftHint: 'A new image is selected; save it before withdrawing.', upload: 'Upload', clear: 'Clear',
    receiptDelete: 'Delete', history: 'Withdrawal history', historyHint: 'Pending requests can be canceled and the amount returned to balance.', recent: 'Last {count}', cancel: 'Cancel withdrawal', empty: 'No withdrawal records',
    submitPending: 'A withdrawal is pending; submit again after it settles or is canceled.', saveDraftFirst: 'Save the new receipt code before using it for withdrawal.', uploadFirst: 'Upload and save a receipt code for this method first.',
    invalidAmount: 'Minimum withdrawal is 1.00 with at most two decimals.', insufficient: 'Balance is insufficient for the amount and fee.', confirmInput: 'Confirm the amount, balance, and receipt code before submitting.',
    invalidType: 'Receipt code must be a PNG, JPEG, GIF, or WebP image', tooLarge: 'Receipt code image cannot exceed 1 MB', selectFile: 'Select a receipt code image first',
    saved: 'Receipt code saved', saveFailed: 'Failed to save receipt code', deleted: 'Receipt code deleted', deleteFailed: 'Failed to delete receipt code', submitted: 'Withdrawal submitted', submitFailed: 'Failed to submit withdrawal', cancelled: 'Withdrawal canceled', cancelFailed: 'Failed to cancel withdrawal', loadFailed: 'Failed to load withdrawal information',
    methods: { alipay: 'Alipay', wechat: 'WeChat' }, statuses: { pending: 'Pending', settled: 'Settled', cancelled: 'Canceled', rejected: 'Rejected' }
  },
  common: {
    loading: 'Loading...',
  ...
  nav: {
    ...
    revenue: 'Revenue',
    accountShareRevenue: 'Account Sharing Revenue',
    freeModels: 'Free Models',
    carpools: 'Carpool Pools',
    modelLobby: 'Model Center',
