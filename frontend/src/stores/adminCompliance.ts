...
// The API may omit custom acknowledgement text on first boot. Keep the
// product-facing fallback aligned with ANL branding; upstream protocol names
// remain unchanged elsewhere for compatibility.
const FALLBACK_ZH_PHRASE = '我已阅读、理解并同意 ANL API 部署与运营合规承诺'
const FALLBACK_EN_PHRASE = 'I have read, understood, and agree to the ANL API Deployment and Operation Compliance Commitment'
