...
const homePath = computed(() => authStore.isAdmin && route.fullPath.startsWith('/admin/') ? '/admin/dashboard' : '/dashboard')
const contactHref = computed(() => appStore.contactInfo?.trim() || '#')
