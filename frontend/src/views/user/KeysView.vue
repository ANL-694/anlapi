  ...
  <AppLayout>
    ...
    <Teleport to="body">
      <div
        ...
        ref="dropdownRef"
        class="animate-in fade-in slide-in-from-top-2 fixed z-[100000020] max-w-[calc(100vw-16px)] overflow-hidden rounded-xl bg-white shadow-lg ring-1 ring-black/5 duration-200 dark:bg-dark-800 dark:ring-white/10"
...
const executeCcsImport = (row: ApiKey, clientType: 'claude' | 'gemini') => {
  ...
  const providerName = (publicSettings.value?.site_name || 'anlapi').trim() || 'anlapi'
