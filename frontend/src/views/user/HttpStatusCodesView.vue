<template>
  <AppLayout>
    <div class="w-full min-w-0 space-y-6 pb-8 http-status-codes-page">
...
.http-status-codes-page {
  ...
  --ui-text-tertiary: #6b7280;
  --ui-radius-md: 0.75rem;
  --ui-radius-lg: 1rem;
}

:global(.dark) .http-status-codes-page {
  --ui-border: #374151;
