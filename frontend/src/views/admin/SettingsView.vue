              ...
              >
                ...
                >
                  ...
                  <p class="mt-1 break-all">
                    ...
                    {{ form.passkey_rp_id || t('admin.settings.security.passkeyValueNotConfigured') }}
                  </p>
                  <p class="mt-1 break-all">
            ...
            <div class="space-y-5 p-6">
              <div class="flex items-center justify-between gap-4">
                ...
                <Toggle
                  ...
                  data-testid="api-key-acl-trust-forwarded-ip"
                />
              </div>
              ...
              >
                ...
                <p
                  class="mt-3 border-l-2 border-amber-500 bg-amber-50 px-3 py-2 text-xs text-amber-900 dark:bg-amber-950/30 dark:text-amber-200"
                >
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              <div class="border-t border-gray-100 pt-4 dark:border-dark-700">
                <div class="mb-4">
                  <label class="font-medium text-gray-900 dark:text-white">
                    {{ t("admin.settings.platformQuotas.defaultTitle") }}
                  </label>
                  <p class="text-sm text-gray-500 dark:text-gray-400">
                    {{ t("admin.settings.platformQuotas.defaultHint") }}
                  </p>
                </div>
                <PlatformQuotaLimitEditor v-model="form.default_platform_quotas" />
              </div>
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      <div class="mb-3">
                        <label class="font-medium text-gray-900 dark:text-white">
                          {{ t("admin.settings.platformQuotas.sourceTitle") }}
                        </label>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                          {{ t("admin.settings.platformQuotas.sourceHint") }}
                        </p>
                      </div>
                      <PlatformQuotaLimitEditor
                        v-model="authSourceDefaults[authSource.source].platform_quotas"
                      />
                    </div>
                ...
                <div>
                  ...
                  <div class="flex items-center gap-2">
                    <Toggle
                      ...
                      "
                      data-testid="payment-alipay-mobile-precreate-deep-link-toggle"
                    />
...
import PlatformQuotaLimitEditor from "@/components/quota/PlatformQuotaLimitEditor.vue";
...
const form = reactive<SettingsForm>({
  ...
  default_platform_quotas: createEmptyPlatformQuotaLimitSettings(),
...
async function loadSettings() {
  ...
  try {
    ...
    form.default_platform_quotas = normalizePlatformQuotaLimitSettings(
...
async function saveSettings() {
  ...
  try {
    ...
    const normalizedDefaultPlatformQuotas = normalizePlatformQuotaLimitSettings(
      form.default_platform_quotas,
    );
    form.default_platform_quotas = normalizedDefaultPlatformQuotas;
    ...
    const payload: UpdateSettingsRequest = {
      ...
      audit_log_retention_days: Math.max(0, Math.floor(Number(form.audit_log_retention_days) || 0)),
      ...
      default_platform_quotas: normalizedDefaultPlatformQuotas,
