...
<template>
  <div class="ops-panel flex h-full min-w-0 flex-col">
    <div
    ...
    >
      ...
      >
        <span class="flex shrink-0 items-center gap-1"><span class="h-2 w-2 rounded-full bg-neutral-900 dark:bg-neutral-100"></span>QPS</span>
        <span class="flex shrink-0 items-center gap-1"><span class="h-2 w-2 rounded-full bg-emerald-600"></span>{{ t('admin.ops.tpsK') }}</span>
