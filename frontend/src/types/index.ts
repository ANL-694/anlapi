...
export interface User {
  ...
  share_income_balance?: number
  points_balance?: number
  recharge_income_balance?: number
  invite_income_balance?: number
...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'opencode_go' | 'custom' | 'kiro' | 'composite'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'grok' | 'kimi' | 'zhipu' | 'deepseek' | 'minimax' | 'opencode_go' | 'custom' | 'kiro'
...
export interface Account {
  ...
  share_status?: AccountShareStatus
