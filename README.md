...
<img src="assets/logo.svg" alt="ANLAPI Logo" width="128" />
...
**ANLAPI · AI API Gateway and Usage Management Platform**

English | [中文](README_CN.md) | [日本語](README_JA.md)

</div>

## ANLAPI Product Layer

ANLAPI is an independently maintained product layer built on the Sub2API-compatible gateway core. It adds separate user/admin workspaces, account-pool operations, model and API-key access control, usage and billing, payments, explicit error states, and deployment verification while preserving compatible gateway routes and provider integrations.

See the [ANLAPI architecture](docs/architecture/ANL_GATEWAY_ARCHITECTURE.md) and [product overview](docs/product/ANL_GATEWAY_PRODUCT_OVERVIEW.md) for the maintained boundaries and portfolio description. The project is based on [Sub2API](https://github.com/Wei-Shaw/sub2api) and remains subject to its upstream license and attribution requirements.
