...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	userRepository := repository.NewUserRepository(client, db, oAuthCredentialVault)
	...
	billingCache := repository.ProvideBillingCache(redisClient, configConfig)
	...
	accountRepository := repository.ProvideAccountRepository(client, db, schedulerCache, oAuthCredentialVault)
	...
	accountService := service.ProvideAccountService(accountRepository, groupRepository, proxyRepository, proxyExitInfoProber)
	...
	userAccountHandler := handler.ProvideUserAccountHandler(accountService, accountUsageService, accountTestService, oAuthService, openAIOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService, accountBatchTaskService, carpoolService, settingService)
	...
	adminAccountRepository := repository.ProvideAdminAccountRepository(client, db, schedulerCache, oAuthCredentialVault)
	...
	receiptCodeStorageConfigProvider := service.ProvideReceiptCodeStorageConfigProvider(configConfig)
	...
	accountShareSettlementService := service.NewAccountShareSettlementService(db)
	accountShareSettlementHandler := admin.NewAccountShareSettlementHandler(accountShareSettlementService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, emailBroadcastHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, grokOAuthHandler, cnProviderHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, pluginHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, contentModerationHandler, promptAdminHandler, paymentHandler, revenueHandler, withdrawalHandler, shopHandler, affiliateHandler, accountSharePolicyHandler, accountShareSettlementHandler, carpoolHandler, complianceHandler, auditLogHandler, moduleHandler, upstreamBillingProbeService, ollamaCloudUsageService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, userAccountHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, channelMonitorV2Handler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, paymentWebhookHandler, receiptCodeHandler, handlerWithdrawalHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, handlerShopHandler, idempotencyCoordinator, idempotencyCleanupService, openAIQuotaAutoResetService)
