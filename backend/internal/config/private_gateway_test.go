...
func TestPrivateGatewaySigningKeyWhitespaceIsRejected(t *testing.T) {
	cfg := PrivateGatewayConfig{Enabled: true, ServiceID: "anl-hub", SigningKey: strings.Repeat("x", 31) + " ", APIKeyID: 1}
