...
func TestCodexBaseInstructionsForModel(t *testing.T) {
	cases := []struct {
		...
		{"gpt-5.6-sol", "You are GPT-5.5 running in the Codex CLI"},
		{"gpt-5.6-terra", "You are GPT-5.5 running in the Codex CLI"},
		{"gpt-5.6-luna", "You are GPT-5.5 running in the Codex CLI"},
