...
func RegisterAdminRoutes(
	...
	admin.Use(middleware.AdminComplianceGuard(settingService))
	{
		...
		registerAccountShareRevenueRoutes(admin, h)
...
func registerAccountShareRevenueRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	revenue := admin.Group("/account-share-revenue")
	policies := revenue.Group("/share-policies")
	...
	settlements := revenue.Group("/share-settlements")
	settlements.GET("", h.Admin.AccountShareSettlement.List)
}
