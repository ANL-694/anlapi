...
// stepUpSettingReader abstracts the system setting used to gate step-up enforcement.
...
//
// step_up_enabled defaults to disabled. When disabled, the middleware passes through.
// When enabled, all of the following conditions must be met:
...
// EnforceStepUpAlways performs the same checks without consulting the feature switch.
