...
func TestAdminAuthJWTValidatesTokenVersion(t *testing.T) {
	...
	t.Run("websocket_token_version_mismatch_rejected", func(t *testing.T) {
		...
		req.Header.Set("Sec-WebSocket-Protocol", "anlapi-admin, jwt."+token)
		router.ServeHTTP(w, req)
...
func (s *stubUserRepo) Update(ctx context.Context, user *service.User, _ service.UserUpdateFields) error {
