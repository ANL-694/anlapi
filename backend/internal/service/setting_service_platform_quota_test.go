...
type platformQuotaSettingRepo struct {
	data map[string]string
}

func (r *platformQuotaSettingRepo) Get(_ context.Context, key string) (*Setting, error) {
	value, ok := r.data[key]
	if !ok {
...
func (r *platformQuotaSettingRepo) GetValue(_ context.Context, key string) (string, error) {
	return r.data[key], nil
}

func (r *platformQuotaSettingRepo) Set(_ context.Context, key, value string) error {
	r.data[key] = value
	return nil
}

func (r *platformQuotaSettingRepo) GetMultiple(_ context.Context, keys []string) (map[string]string, error) {
...
func (r *platformQuotaSettingRepo) SetMultiple(_ context.Context, values map[string]string) error {
...
func (r *platformQuotaSettingRepo) GetAll(_ context.Context) (map[string]string, error) {
...
func (r *platformQuotaSettingRepo) Delete(_ context.Context, key string) error {
	delete(r.data, key)
	return nil
}
