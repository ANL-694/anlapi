...
func (r *adminComplianceRepoStub) GetMultiple(context.Context, []string) (map[string]string, error) {
	return map[string]string{}, nil
}

func (r *adminComplianceRepoStub) SetMultiple(context.Context, map[string]string) error {
	return nil
}

func (r *adminComplianceRepoStub) GetAll(context.Context) (map[string]string, error) {
	return map[string]string{}, nil
}

func (r *adminComplianceRepoStub) Delete(_ context.Context, key string) error {
	delete(r.values, key)
	return nil
}
