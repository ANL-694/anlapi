...
func (s *AccountTestService) testOpenAIAccountConnection(c *gin.Context, account *Account, modelID string, prompt string, mode string) error {
	...
	if credentialAccount.IsOAuth() {
		...
		if account.IsFreeModelOpenAICompatible() || !shouldUseResponsesAPIForAccountModel(credentialAccount, testModelID, "") {
...
func (s *AccountTestService) testGrokAccountConnection(c *gin.Context, account *Account, modelID string, prompt string) error {
	...
	payloadBytes, err := buildGrokResponsesProbeBody(testModelID, testPrompt)
	if err != nil {
