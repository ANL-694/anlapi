...
func (m *opsRepoMock) BatchUpsertIngressRejects(ctx context.Context, items []*OpsIngressRejectAggregate) error {
	return nil
}

func (m *opsRepoMock) ListIngressRejects(ctx context.Context, filter *OpsIngressRejectFilter) (*OpsIngressRejectList, error) {
