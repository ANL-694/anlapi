...
func (a *Account) IsPublicShareApproved() bool {
	return a != nil && a.OwnerUserID != nil &&
...
// IsQuotaExceededAt is the time-aware scheduling hook used by account pools.
func (a *Account) IsQuotaExceededAt(_ time.Time) bool {
