...
type Account struct {
	...
	// ParentAccountID and QuotaDimension describe linked credential-shadow routing.
...
func (a *Account) SupportsOpenAIEndpointCapability(capability OpenAIEndpointCapability) bool {
	...
	if a.IsGrok() {
		...
		case OpenAIEndpointCapabilityGrokMediaGeneration:
			...
			// request path can run the billing probe before forwarding.
...
// IsShadow reports whether this account delegates credentials to a parent.
