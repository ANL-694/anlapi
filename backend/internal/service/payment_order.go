...
func (s *PaymentService) prepareCreateOrder(ctx context.Context, req CreateOrderRequest) (*createOrderPreparation, error) {
	...
	return &createOrderPreparation{Request: req, Config: cfg, User: user, Plan: plan, OrderAmount: orderAmount, LimitAmount: limitAmount, FeeRate: feeRate, PayAmount: payAmount, PayAmountStr: payAmountStr, Selection: sel, OAuth: oauthResp}, nil
}
