...
type receiptCodeConfigProvider struct {
	cfg *config.Config
}

func ProvideReceiptCodeStorageConfigProvider(cfg *config.Config) ReceiptCodeStorageConfigProvider {
	return receiptCodeConfigProvider{cfg: cfg}
}

func (p receiptCodeConfigProvider) GetReceiptCodeStorageConfig(context.Context) (config.ReceiptCodeStorageConfig, error) {
	if p.cfg == nil {
