...
// openAIImagesResponsesMainModelValue selects the Responses driver separately
// from the image_generation tool model. Operators can change it when an
// upstream driver is retired without rebuilding the gateway.
