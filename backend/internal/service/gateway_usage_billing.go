...
func buildUsageBillingCommand(requestID string, usageLog *UsageLog, p *postUsageBillingParams) *UsageBillingCommand {
	...
	if usageLog != nil {
		cmd.PricingVersion = strings.TrimSpace(usageLog.PricingVersion)
	}
...
func (s *GatewayService) calculateRecordUsageCost(
	...
	if result.SearchCount > 0 {
		...
		if searchCost != nil {
			...
			tokenCost.PricingVersion = CombinePricingSnapshotVersions(
				tokenCost.PricingVersion,
				searchCost.PricingVersion,
			)
		}
	}
	return tokenCost
