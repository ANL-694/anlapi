...
func TestCalculateImageCost_DefaultPricing(t *testing.T) {
	...
	require.Equal(t, svc.CalculateImageCost("gemini-3-pro-image", "2K", 1, nil, 1.0).PricingVersion, cost.PricingVersion)
}
...
func TestCalculateImageCost_GroupCustomPricing(t *testing.T) {
	...
	require.NotEqual(t, cost.PricingVersion, svc.CalculateImageCost("gemini-3-pro-image", "1K", 1, groupConfig, 1.0).PricingVersion)
...
func TestCalculateImageCost_4KDoublePrice(t *testing.T) {
	...
	require.NotEmpty(t, cost.PricingVersion)
	require.NotEqual(t, cost.PricingVersion, svc.CalculateImageCost("gemini-3-pro-image", "2K", 1, nil, 1.0).PricingVersion)
}
