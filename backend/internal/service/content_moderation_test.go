...
func TestBuildContentModerationLog_RedactsInputExcerpt(t *testing.T) {
	...
	log := svc.buildLog(input, cfg, ContentModerationActionAllow, true, "sexual", 0.8, map[string]float64{"sexual": 0.8}, "hello api_key=fixture-credential-1234567890abcdef", nil, nil, "")

	require.NotContains(t, log.InputExcerpt, "fixture-credential-1234567890abcdef")
...
func TestExtractContentModerationInput_OpenAIResponsesCodexPayloadUsesLastUserMessage(t *testing.T) {
	body := []byte(`{
		...
		"input":[
			{"type":"message","role":"developer","content":[{"type":"input_text","text":"developer permissions api_key=fixture-credential-1234567890abcdef"}]},
