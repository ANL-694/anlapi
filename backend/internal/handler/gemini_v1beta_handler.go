...
func (h *GatewayHandler) GeminiV1BetaListModels(c *gin.Context) {
	...
	// 强制 antigravity 模式：返回当前账号映射出的模型列表
	...
	// Preserve the upstream envelope while adding schedulable Antigravity models
	// when the account pool exposes mixed Gemini routing.
