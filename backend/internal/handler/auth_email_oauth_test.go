...
func (r *oauthEmailAffiliateRepoStub) GetCurrentInviteSharePercent(context.Context) (float64, error) {
	panic("unexpected GetCurrentInviteSharePercent call")
}
...
func (r *oauthEmailAffiliateRepoStub) ListInvitees(context.Context, int64, service.AffiliateDetailQuery, int) ([]service.AffiliateInvitee, float64, error) {
