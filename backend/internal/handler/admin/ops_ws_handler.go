...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["anlapi-admin", "jwt.<token>"].
	// - We always select "anlapi-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"anlapi-admin"},
}
