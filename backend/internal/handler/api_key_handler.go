...
// EnsureImageGenerationKey reconciles the current user's platform-managed
// image-generation key. The repository provides durable single-winner
// semantics across concurrent requests.
