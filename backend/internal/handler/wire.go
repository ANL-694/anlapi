...
func ProvideAdminHandlers(
	...
	accountShareSettlementHandler *admin.AccountShareSettlementHandler,
	...
	return &AdminHandlers{
		...
		AccountShareSettlement: accountShareSettlementHandler,
...
func ProvideUserAccountHandler(
	...
	h := NewUserAccountHandler(accountService, accountUsageService, accountTestService)
	h.SetOAuthServices(oauthService, openaiOAuthService, geminiOAuthService, antigravityOAuthService, grokOAuthService)
	h.SetAccountBatchTaskService(accountBatchTaskService)
...
var ProviderSet = wire.NewSet(
	...
	admin.NewAccountShareSettlementHandler,
