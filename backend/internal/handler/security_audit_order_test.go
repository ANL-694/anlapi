...
func TestPromptAuditGatePrecedesAccountBillingAndUpstreamSideEffects(t *testing.T) {
	tests := []promptAuditOrderCase{
		{file: "gateway_handler.go", function: "Messages", auditToken: "runPreFlightHooks"},
		{file: "gateway_handler_chat_completions.go", function: "ChatCompletions", auditToken: "runPreFlightHooks"},
		{file: "gateway_handler_responses.go", function: "Responses", auditToken: "runPreFlightHooks"},
		{file: "gemini_v1beta_handler.go", function: "GeminiV1BetaModels", auditToken: "runPreFlightHooks"},
		{file: "openai_gateway_handler.go", function: "Responses", auditToken: "runPreFlightHooks"},
		{file: "openai_gateway_handler.go", function: "Messages", auditToken: "runPreFlightHooks"},
		{file: "openai_chat_completions.go", function: "ChatCompletions", auditToken: "runPreFlightHooks"},
		{file: "openai_images.go", function: "Images", auditToken: "runPreFlightHooks"},
