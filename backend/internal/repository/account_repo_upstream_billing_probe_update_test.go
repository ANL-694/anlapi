...
func updatedAccountRows(id int64, extra string) *sqlmock.Rows {
	...
	values := []driver.Value{
		...
		[]byte(`{"api_key":"sk-test"}`), []byte(extra), nil, nil, nil, nil, nil, nil,
		1, 1.0, 1, 1.0, service.StatusActive, nil, nil, nil, false, true,
		nil, nil, nil, nil, nil, nil, nil, nil, service.QuotaDimensionGlobal,
	}
