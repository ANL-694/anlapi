...
func updatedAccountRows(id int64, extra string) *sqlmock.Rows {
	...
	return sqlmock.NewRows(dbaccount.Columns).AddRow(
		id, now, now, nil, "test", service.AccountLevelUnknown, nil,
		service.PlatformOpenAI, service.AccountTypeAPIKey,
		[]byte(`{"api_key":"sk-test"}`), []byte(extra),
		nil, service.AccountShareModePrivate, service.AccountShareStatusApproved, nil,
		nil, nil, 1, nil, 1, 1.0,
