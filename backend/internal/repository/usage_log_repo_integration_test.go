...
func TestUsageLogRepositoryCreateBestEffort_BatchPathDuplicateRequestID(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "fixture-usage-best-effort-dup-" + uuid.NewString(), Name: "k"})
...
func TestUsageLogRepositoryCreate_BatchPathCanceledAfterQueueMarksNotPersisted(t *testing.T) {
	...
	apiKey := mustCreateApiKey(t, client, &service.APIKey{UserID: user.ID, Key: "fixture-usage-cancel-queued-" + uuid.NewString(), Name: "k"})
...
func (s *UsageLogRepoSuite) TestGetByID_ReturnsRequestTypeAndLegacyFallback() {
	...
	apiKey := mustCreateApiKey(s.T(), s.client, &service.APIKey{UserID: user.ID, Key: "fixture-getbyid-request-type", Name: "k"})
