...
var ProviderSet = wire.NewSet(
	...
	NewPrivateGatewayNonceRepository,
	NewPrivateGatewayStateRepository,
...
// ProvideAccountRepository adapts the variadic constructor for Wire.
// The variadic form is retained on the public constructor for existing tests
// and callers, while production wiring always supplies the configured vault.
func ProvideAccountRepository(client *ent.Client, sqlDB *sql.DB, schedulerCache service.SchedulerCache, vault service.OAuthCredentialVault) service.AccountRepository {
	return NewAccountRepository(client, sqlDB, schedulerCache, vault)
}

// ProvideAdminAccountRepository adapts the variadic constructor for Wire.
func ProvideAdminAccountRepository(client *ent.Client, sqlDB *sql.DB, schedulerCache service.SchedulerCache, vault service.OAuthCredentialVault) service.AdminAccountRepository {
	return NewAdminAccountRepository(client, sqlDB, schedulerCache, vault)
}
