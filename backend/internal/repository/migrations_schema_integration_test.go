...
func TestMigrationsRunner_IsIdempotent_AndSchemaIsUpToDate(t *testing.T) {
	...
	requireColumn(t, tx, "usage_logs", "pricing_version", "character varying", 128, true)
...
`, usageLogsUpstreamModelMismatchIndex).Scan(&mismatchIndexDef))
	...
	requireColumn(t, tx, "usage_billing_dedup", "pricing_version", "character varying", 128, true)
	...
	requireColumn(t, tx, "usage_billing_dedup_archive", "pricing_version", "character varying", 128, true)
