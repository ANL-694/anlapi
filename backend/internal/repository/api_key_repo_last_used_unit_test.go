...
func TestAPIKeyRepositoryListByUserIDAttachesLastUsedIP(t *testing.T) {
	...
	withLogs := &service.APIKey{
		UserID: user.ID,
		Key:    "fixture-list-last-used-ip-logs",
		Name:   "With Logs",
		Status: service.StatusActive,
	}
	emptyOnly := &service.APIKey{
		UserID: user.ID,
		Key:    "fixture-list-last-used-ip-empty",
		Name:   "Empty Only",
		Status: service.StatusActive,
	}
	noLogs := &service.APIKey{
		UserID: user.ID,
		Key:    "fixture-list-last-used-ip-none",
		Name:   "No Logs",
		Status: service.StatusActive,
	}
...
func TestAPIKeyRepository_UpdateLastUsedDeletedKey(t *testing.T) {
	...
	key := &service.APIKey{
		UserID: user.ID,
		Key:    "fixture-update-last-used-deleted",
...
func TestAPIKeyRepository_UpdateLastUsedDBError(t *testing.T) {
	...
	key := &service.APIKey{
		UserID: user.ID,
		Key:    "fixture-update-last-used-db-error",
