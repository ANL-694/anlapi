...
func (_c *GroupCreate) SetScope(v group.Scope) *GroupCreate {
	_c.mutation.SetScope(v)
	return _c
}

// SetNillableScope sets the "scope" field if the given value is not nil.
func (_c *GroupCreate) SetNillableScope(v *group.Scope) *GroupCreate {
	if v != nil {
		_c.SetScope(*v)
	}
	return _c
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Scope(); ok {
		_spec.SetField(group.FieldScope, field.TypeEnum, value)
		_node.Scope = value
	}
...
// SetScope sets the "scope" field.
func (u *GroupUpsert) SetScope(v group.Scope) *GroupUpsert {
...
// SetScope sets the "scope" field.
func (u *GroupUpsertOne) SetScope(v group.Scope) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.SetScope(v)
	})
}
...
// SetScope sets the "scope" field.
func (u *GroupUpsertBulk) SetScope(v group.Scope) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetScope(v)
	})
}
