...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldBalance, user.FieldRechargeBalance, user.FieldInviteIncomeBalance, user.FieldShareIncomeBalance, user.FieldPointsBalance, user.FieldFrozenBalance, user.FieldBalanceNotifyThreshold, user.FieldTotalRecharged, user.FieldTotalInviteIncome, user.FieldTotalShareIncome:
