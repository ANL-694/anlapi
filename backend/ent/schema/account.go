...
func (Account) Fields() []ent.Field {
	return []ent.Field{
		...
		// owner_user_id is set only for an account belonging to one user-private
		// group. NULL keeps the official shared/admin account behavior.
...
func (Account) Indexes() []ent.Index {
	return []ent.Index{
		...
		index.Fields("owner_user_id"),       // 私有账号按 owner 筛选
