...
type Group struct {
	...
	Scope group.Scope `json:"scope,omitempty"`
...
func (*Group) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case group.FieldName, group.FieldDescription, group.FieldPeakStart, group.FieldPeakEnd, group.FieldStatus, group.FieldScope, group.FieldDuplicateOperationID, group.FieldPlatform, group.FieldSubscriptionType, group.FieldDefaultMappedModel, group.FieldMaxReasoningEffort, group.FieldMaxReasoningEffortOverLimit:
	...
	for i := range columns {
		...
		case group.FieldScope:
			if value, ok := values[i].(*sql.NullString); !ok {
				...
				_m.Scope = group.Scope(value.String)
			}
