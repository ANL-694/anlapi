...
var (
	...
	AccountsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			},
			{
				...
				Unique:  false,
				Columns: []*schema.Column{AccountsColumns[12], AccountsColumns[13]},
			},
			{
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
		{Name: "scope", Type: field.TypeEnum, Enums: []string{"public", "user_private", "user_carpool"}, Default: "public"},
		{Name: "owner_user_id", Type: field.TypeInt64, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "pricing_version", Type: field.TypeString, Nullable: true, Size: 128},
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
