...
func init() {
	...
	accountDescShareMode := accountFields[9].Descriptor()
	...
	accountDescShareStatus := accountFields[10].Descriptor()
	...
	usagelogDescPricingVersion := usagelogFields[27].Descriptor()
	// usagelog.PricingVersionValidator is a validator for the "pricing_version" field. It is called by the builders before save.
	usagelog.PricingVersionValidator = usagelogDescPricingVersion.Validators[0].(func(string) error)
	...
	userDescFrozenBalance := userFields[9].Descriptor()
	...
	userDescConcurrency := userFields[10].Descriptor()
	...
	userDescRestrictPublicGroups := userFields[20].Descriptor()
	...
	userDescTotalInviteIncome := userFields[26].Descriptor()
	...
	userDescTotalShareIncome := userFields[27].Descriptor()
