...
var (
	...
	// PricingVersionValidator is a validator for the "pricing_version" field. It is called by the builders before save.
	PricingVersionValidator func(string) error
