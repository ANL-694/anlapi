...
// ScopePublic is the default value of the Scope enum.
...
const (
	...
	ScopeUserCarpool Scope = "user_carpool"
)
...
func ScopeValidator(s Scope) error {
	switch s {
	case ScopePublic, ScopeUserPrivate, ScopeUserCarpool:
		return nil
	default:
		return fmt.Errorf("group: invalid enum value for scope field: %q", s)
	}
}
