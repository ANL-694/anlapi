-- Durable bindings for platform-managed API keys.
-- The user/purpose uniqueness constraint is the concurrency boundary for
-- ensure calls; the API key itself remains an ordinary soft-deletable row.
