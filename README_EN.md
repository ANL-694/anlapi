...
The current implementation snapshot uses the official Sub2API `v0.1.176` main baseline and selectively replays ANL API contracts for the UI, routing, account isolation, image generation, and operations. Deployment readiness is determined by the batch evidence and release gate, not by this README alone.
...
- [ANL Gateway architecture](docs/architecture/ANL_GATEWAY_ARCHITECTURE.md)
- [ANL Gateway product overview](docs/product/ANL_GATEWAY_PRODUCT_OVERVIEW.md)
